...
const (
	...
	trueMaxRoleID   = "1481711241285079141"
	hcRoleID        = "985327939161849857"
	fcRoleID        = "985328007088590918"
	iceRoleID       = "985329015118266409"
	fireRoleID      = "985329114980446248"
	jackerRoleID    = "985329239903567993"
...
var (
	...
	multiplayerAchievRegex     = regexp.MustCompile(`skunked|invasion|headhunter|negative(\s|,)*ghost\s*rider|skull[a]?manjaro|grand theft halo|double down|blown out.*sky|decorated warrior|ninja redux|flaming ninja anniversary|legend slayer|invaders repelled|put up your dukes|red vs\.? blue|shield[s]? up|shook the hornet('s|s)? nest|skeet shooter|goose is loose|top gungoose|bombing run|cold as ice|cold fusion|counter(-|\s)?snipe|triple threat|wetwork|roadkill rampage|rock and coil|splatter|environmentalist|requiescat|easy to overlook|back in the day`)
